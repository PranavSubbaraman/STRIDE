...
python -u run.py \
  ...
  --draft_scale_d_ff 0.25 \
  --draft_scale_e_layers 0.25 \
  --test_dir forecast_ETTm2_draft_timer_xl_draft_MultivariateDatasetBenchmark_sl1536_it96_ot96_lr5e-05_bt64_wd0_el1_dm1024_dff2048_nh8_cosTrue_test_0 \
