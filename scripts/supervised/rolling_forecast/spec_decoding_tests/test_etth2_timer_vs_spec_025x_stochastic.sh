...
# ETTh2 target checkpoint (Timer-XL standard config)
TARGET_TEST_DIR="forecast_ETTh2_timer_xl_MultivariateDatasetBenchmark_sl1536_it96_ot96_lr0.0001_bt64_wd0_el1_dm1024_dff2048_nh8_cosFalse_test_0"
TARGET_CKPT="checkpoint.pth"


# Stochastic draft checkpoint (will be generated after training)
DRAFT_TEST_DIR="forecast_ETTh2_draft_distill_stochastic_from_target_timer_xl_draft_MultivariateDatasetBenchmark_sl1536_it96_ot96_lr5e-05_bt64_wd0_el1_dm1024_dff2048_nh8_cosTrue_test_0"
DRAFT_CKPT="checkpoint.pth"

# echo "[1/2] Baseline test: timer_xl on ETTh2"
# python -u run.py \
#   --task_name forecast \
#   --is_training 0 \
