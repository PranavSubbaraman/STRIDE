...
DRAFT_TEST_DIR="forecast_001x_ETTh1_draft_distill_stochastic_from_target_timer_xl_draft_MultivariateDatasetBenchmark_sl1536_it96_ot96_lr5e-05_bt64_wd0_el1_dm1024_dff2048_nh8_cosTrue_test_0"
...
echo "[2/2] Speculative test with stochastic draft: timer_xl + timer_xl_draft (NLL-trained)"
python -u run.py \
  --task_name forecast \
  --is_training 0 \
  --root_path ./dataset/ETT-small/ \
  ...
  --draft_stochastic \
  --spec_debug_accept \
  --spec_debug_out spec_decoding_stochastic_001x.csv \
  --trace_inference_breakdown \
